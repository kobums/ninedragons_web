...
export const RF_ACTIONS: Record<RFMenuKind, RFActionMeta> = {
  ...
  convert: {
    ...
    attack: false,
    extra: true,
    effect: '내 진영 전환 · 은화 1개 피난처로',
    counter: '도전·저지 불가 (즉시 발동)',
  },
  convert_other: {
    label: '다른 플레이어 개종',
    icon: '↔️',
    ...
    attack: false,
    extra: true,
    effect: '대상 진영 전환 · 은화 2개 피난처로',
    counter: '도전·저지 불가 · 같은 진영도 가능',
  },
  embezzle: {
    label: '횡령',
    icon: '🏦',
