...
export const GAMES: Record<GameId, GameMeta> = {
    ...
    rules: [
      {
        ...
        items: [
          ...
          '8장을 받고 라지티츄(성공 +200/실패 -200)를 선언할 수 있습니다. 이후 6장을 더 받고, 다른 세 명에게 카드를 1장씩 넘겨 교환합니다.',
          '첫 카드를 내기 전까지 스몰티츄(성공 +100/실패 -100)를 선언할 수 있습니다. 성공 조건은 내가 그 핸드에서 1등으로 털기입니다.',
        ],
      },
      {
        heading: '진행 (클라이밍)',
    ...
    rules: [
      ...
      },
      {
        ...
        items: [
          ...
          '단독 최다 득표자가 스파이면 일반인 승리, 그 외(오지목·동표)는 스파이 승리입니다.',
        ],
      },
    ],
  },
    ...
    rules: [
      {
        ...
        items: [
          ...
          '차례에 카드를 더 내려놓거나, "장미 N장을 뒤집겠다"고 베팅합니다. 베팅이 시작되면 레이즈 또는 패스만 가능합니다.',
          '최고 베팅자는 자기 더미를 전부 뒤집은 뒤 상대 더미를 골라 뒤집습니다. 해골이 나오면 실패 — 내 카드 1장을 잃습니다.',
        ],
      },
      {
        heading: '승리',
    ...
    rules: [
      {
        heading: '진행',
        items: [
          '25개 단어 중 빨간 팀 9 · 파란 팀 8 · 행인 7 · 암살자 1 — 배치는 각 팀 팀장만 봅니다.',
          '팀장이 "단어 하나 + 숫자" 힌트를 내면(음성 추천, 앱에 기록) 팀원들이 아군 단어를 추측합니다. 숫자+1번까지 계속할 수 있습니다.',
          '행인이나 상대 단어를 고르면 턴이 넘어가고, 암살자를 고르면 그 팀이 즉시 패배합니다.',
        ],
      },
      {
        heading: '승리',
        items: [
          ...
          '팀 배정은 입장 순서로 번갈아, 팀장은 팀의 첫 사람이 맡습니다.',
        ],
      },
    ],
  },
    ...
    rules: [
      {
        heading: '진행',
        items: [
          '각자 비공개 역할 카드 2장과 은화 2개로 시작합니다. 카드 2장을 모두 잃으면 탈락합니다.',
          '차례에 행동을 선택합니다 — 소득(+1), 외부 원조(+2), 세금 징수(공작, +3), 암살(은화 3), 갈취(사령관), 캐릭터 교환(대사), 쿠데타(은화 7, 저지 불가).',
          '역할이 필요한 행동은 카드가 없어도 "주장"할 수 있습니다 — 거짓말이 핵심입니다!',
        ],
      },
      {
        heading: '도전과 저지',
        items: [
          ...
          '외부 원조는 공작, 암살은 백작 부인, 갈취는 사령관/대사 주장으로 저지할 수 있습니다 (저지도 도전 가능).',
          '은화가 10개 이상이면 반드시 쿠데타를 해야 합니다. 마지막까지 살아남으면 승리!',
        ],
      },
    ],
  },
    ...
    rules: [
      {
        ...
        items: [
          ...
          '매 라운드 전원이 동시에 1장을 골라 일괄 공개 — 낮은 카드부터 자기보다 작은 행 끝 중 가장 큰 행에 붙습니다.',
    ...
    rules: [
      {
        heading: '역할',
        items: [
          '마스터 1명(전원에게 공개), 인사이더 1명(비공개), 나머지는 일반인입니다.',
          '테마는 마스터와 인사이더만 봅니다 — 인사이더는 아는 척하지 않으면서 정답을 유도해야 합니다.',
          '질문과 대답은 같은 공간(또는 음성)에서 — 앱은 역할·테마·타이머·투표를 진행합니다.',
        ],
      },
      {
        heading: '진행',
        items: [
          '질문 타임 5분 — 스무고개로 테마를 맞힙니다. 마스터는 예/아니오로만 답하고, 정답이 나오면 [정답 나옴]을 누릅니다.',
          '토론 타임 2분 — "정답을 맞힌 사람이 인사이더인가?"를 토론합니다.',
          '투표 — 전원이 인사이더로 의심되는 1명을 지목합니다. 최다 득표자가 인사이더면 일반인 승리, 아니면 인사이더 승리!',
  ...
  crew: {
    ...
    title: '더 크루',
    tag: '협력 · 트릭테이킹',
    description: '말없이 손발 맞춰 과제를 완수하는 우주 원정',
    players: '3~5인',
    minPlayers: 3,
    maxPlayers: 5,
    categories: ['협력', '트릭테이킹'],
    ...
    rules: [
      ...
      },
      {
        heading: '과제',
        items: [
          '과제 카드가 각자에게 배정됩니다 — 담당자가 그 카드가 들어간 트릭을 이겨야 합니다.',
          '엉뚱한 사람이 그 트릭을 이기면 즉시 실패! 카드가 다 떨어졌는데 과제가 남아도 실패입니다.',
          '과제를 다 완수하면 다음 임무로, 5임무까지 마치면 클리어입니다.',
        ],
      },
      {
        heading: '통신 제약',
        items: [
          '이 게임의 핵심 — 상의가 금지됩니다. 임무마다 통신 토큰 한 번으로 카드 한 장을 공개할 수 있을 뿐입니다.',
    ...
    rules: [
      {
        heading: '세트란',
        items: [
          '카드마다 모양·색깔·개수·음영 네 가지 속성이 있습니다.',
  ...
  reformation: {
    ...
    title: '쿠: 리포메이션',
    tag: '블러핑 · 진영',
    description: '두 진영으로 갈린 궁정 — 피난처를 노리는 음모전',
    players: '2~10인',
    minPlayers: 2,
    maxPlayers: 10,
    categories: ['정체 은닉', '블러핑'],
    ...
    rules: [
      {
        heading: '기본은 쿠와 같습니다',
        items: [
          '비공개 역할 카드 2장과 은화 2개로 시작하고, 카드를 모두 잃으면 탈락합니다.',
          '역할이 없어도 주장할 수 있습니다 — 도전당하면 진실이 드러납니다.',
          '은화가 10개 이상이면 반드시 쿠데타를 해야 합니다.',
        ],
      },
      {
        heading: '진영',
        items: [
          ...
          '같은 진영끼리는 갈취·암살·쿠데타를 할 수 없습니다 — 누구와 한 편인지가 판을 바꿉니다.',
      ...
      },
      {
        heading: '피난처와 개종',
        items: [
          '개종(은화 1개)과 다른 플레이어 개종(은화 2개)으로 판을 뒤집을 수 있습니다. 낸 은화는 피난처에 쌓입니다.',
          '횡령으로 피난처의 은화를 통째로 가져올 수 있습니다 — 다만 "나는 공작이 아니다"를 증명해야 합니다.',
          '개종 선언은 도전·저지 대상이 아닙니다. 횡령은 도전할 수 있습니다.',
        ],
      },
    ],
  },
  saboteur: {
    ...
    title: '사보타지',
    tag: '정체 은닉 · 길 놓기',
    description: '금맥까지 길을 잇는 광부와, 몰래 막는 방해꾼',
    players: '3~10인',
    minPlayers: 3,
    maxPlayers: 10,
    categories: ['정체 은닉', '전략'],
    ...
    rules: [
      {
        ...
        items: [
          ...
          '방해꾼은 카드가 다 떨어질 때까지 길을 막으면 승리합니다.',
          '역할은 인원수보다 많은 풀에서 뽑아 나눠주므로, 방해꾼이 정확히 몇 명인지는 아무도 모릅니다.',
        ],
      },
      {
        heading: '차례',
        items: [
          ...
          '굴 카드는 이미 이어진 길에 맞닿아야 하고, 인접한 변의 통로 모양이 맞아야 놓을 수 있습니다.',
          '막다른 길 카드 뒤로는 길이 이어지지 않습니다 — 티 나지 않게 막는 데 쓰입니다.',
        ],
      },
      {
        heading: '행동 카드',
        items: [
          '⛏🛒🏮 도구를 부수면 그 사람은 굴 카드를 놓을 수 없습니다. 수리 카드로 고칠 수 있습니다.',
          '🗺 지도로 목적지 카드 하나를 몰래 확인하고, 낙석으로 이미 놓인 카드를 걷어낼 수 있습니다.',
          '목적지는 세 곳 중 하나에만 금이 있습니다 — 길이 닿으면 그 자리에서 공개됩니다.',
        ],
      },
    ],
  },
  splendor: {
    ...
    title: '스플렌더',
    tag: '엔진 빌딩 · 보석',
    description: '보석을 모아 상단으로 — 명성 15점 경주',
    players: '2~4인',
    minPlayers: 2,
    maxPlayers: 4,
    categories: ['전략'],
    duration: '25-35분',
    wsPath: '/ws/splendor',
    logPrefix: '[Splendor] WebSocket',
    sessionKey: 'sl_session_id',
    rules: [
      {
        heading: '차례에 하나만',
        items: [
          '서로 다른 색 보석 3개를 가져오거나, 같은 색 2개를 가져옵니다 (그 색이 공동 창고에 4개 이상일 때만).',
          '개발 카드를 예약해 손에 쥐면 황금 1개를 함께 받습니다 (최대 3장).',
          '개발 카드를 구매합니다 — 진열된 카드나 내가 예약한 카드 중에서.',
        ],
      },
      {
        heading: '보석과 카드',
        items: [
          '보석은 다이아몬드·사파이어·에메랄드·루비·줄마노 다섯 가지, 그리고 만능인 황금이 있습니다.',
          '구매한 개발 카드는 그 색 보너스가 되어 이후 비용을 영구히 깎아 줍니다 — 이게 엔진입니다.',
          '보유 보석은 10개를 넘길 수 없어, 넘치면 차례 끝에 버려야 합니다.',
        ],
      },
      {
        heading: '귀족과 승리',
        items: [
          '차례 끝에 귀족 타일이 요구하는 보너스를 모두 갖추면 자동으로 방문해 명성 점수를 줍니다.',
          '누군가 명성 15점에 닿으면 그 라운드를 끝까지 진행하고 종료 — 최고점이 승리합니다.',
          '동점이면 개발 카드를 적게 산 쪽이 이깁니다.',
        ],
      },
    ],
  },
  azul: {
    ...
    title: '아줄',
    tag: '타일 드래프트 · 배치',
    description: '진열대에서 타일을 골라 벽을 채우는 타일 퍼즐',
    players: '2~4인',
    minPlayers: 2,
    maxPlayers: 4,
    categories: ['전략'],
    duration: '30-45분',
    wsPath: '/ws/azul',
    logPrefix: '[Azul] WebSocket',
    sessionKey: 'az_session_id',
    rules: [
      {
        heading: '공장 수주',
        items: [
          '진열대 하나에서 같은 색 타일을 전부 가져오고, 남은 타일은 중앙으로 밀려납니다.',
          '중앙에서 가져올 수도 있습니다. 다만 그 라운드에 처음 중앙을 건드리면 선 플레이어 마커를 받아 바닥 라인에 놓습니다.',
          '가져온 타일은 패턴 라인 한 줄에 놓습니다. 줄이 넘치거나 놓을 곳이 없으면 바닥 라인으로 떨어져 감점이 됩니다.',
        ],
      },
      {
        heading: '벽 타일 붙이기',
        items: [
          '꽉 찬 패턴 라인마다 타일 한 장을 벽의 정해진 칸으로 옮깁니다.',
          '붙인 칸에서 가로·세로로 이어진 만큼 점수를 받습니다. 양쪽 다 이어져 있으면 더합니다.',
          '바닥 라인에 쌓인 타일은 1·1·2·2·2·3·3점씩 깎습니다.',
        ],
      },
      {
        heading: '종료',
        items: [
          '누군가 벽의 가로줄 하나를 완성하면 그 라운드를 마치고 끝납니다.',
          '마지막에 완성된 가로줄 2점, 세로줄 7점, 같은 색 5장 10점을 더해 최고점이 승리합니다.',
        ],
      },
    ],
  },
  citadels: {
    ...
    title: '시타델',
    tag: '역할 드래프트 · 건설',
    description: '직업을 골라 도시를 세우는 중세 권모술수',
    players: '3~7인',
    minPlayers: 3,
    maxPlayers: 7,
    categories: ['전략', '블러핑'],
    duration: '30-45분',
    wsPath: '/ws/citadels',
    logPrefix: '[Citadels] WebSocket',
    sessionKey: 'ct_session_id',
    rules: [
      {
        heading: '라운드는 두 단계',
        items: [
          '먼저 직업 8종에서 한 장씩 골라 비밀리에 손에 쥡니다 — 일부는 아예 빠지고, 누가 뭘 골랐는지 모릅니다.',
          '그다음 1번부터 8번까지 순서대로 호출합니다. 자기 번호가 불리면 정체를 밝히고 차례를 진행합니다.',
        ],
      },
      {
        heading: '직업 8종',
        items: [
          '1 암살자 — 직업 하나를 지목해 그 차례를 통째로 없앱니다. 2 도둑 — 지목한 직업의 금화를 전부 빼앗습니다.',
          '3 마술사 — 손패를 남과 바꾸거나 버리고 새로 뽑습니다. 4 왕 — 왕관을 가져오고 귀족 건물 수입을 받습니다.',
          '5 주교(종교) · 6 상인(상업) · 8 장군(군사)은 자기 색 건물마다 금화를 받고, 장군은 남의 건물을 부술 수 있습니다. 7 건축가는 한 차례에 3채까지 짓습니다.',
        ],
      },
      {
        heading: '차례와 승리',
        items: [
          '차례마다 금화 2를 받거나 건물 카드를 뽑고, 이어서 건물을 짓고, 마지막에 직업 능력을 씁니다.',
          '누군가 건물 7채를 완성하면 그 라운드를 마치고 종료합니다.',
          '건물값 합에 먼저 완성 4점, 완성 2점, 다섯 색을 모두 갖추면 3점을 더해 최고점이 승리합니다.',
        ],
      },
    ],
  },
  startups: {
    ...
    title: '스타트업스',
    tag: '투자 · 대주주 다툼',
    description: '회사 주식을 모아 대주주가 되는 짧고 매운 투자전',
    players: '3~7인',
    minPlayers: 3,
    maxPlayers: 7,
    categories: ['전략', '블러핑'],
    duration: '20-30분',
    wsPath: '/ws/startups',
    logPrefix: '[Startups] WebSocket',
    sessionKey: 'su_session_id',
    rules: [
      {
        heading: '차례',
        items: [
          '카드를 하나 얻고, 손패에서 한 장을 시장에 내려놓습니다.',
          '덱에서 뽑으면 비공개로 손에 들어오고, 시장에서 가져오면 내 앞에 공개로 쌓입니다.',
          '덱에서 뽑은 사람은 시장에 남은 카드마다 안티(판돈) 1원을 얹어야 합니다. 그 카드를 나중에 가져가는 사람이 쌓인 안티를 전부 받습니다.',
        ],
      },
      {
        heading: '대주주의 제약',
        items: [
          '어떤 회사의 공개 카드를 가장 많이 가진 사람이 그 회사의 대주주입니다. 동수면 대주주가 없습니다.',
          '내가 대주주인 회사 카드는 덱에서 가져올 수 없습니다 — 돈 1원을 덱에 얹고 다시 뽑아야 합니다.',
          '그래서 대주주 자리를 굳힐수록 덱이 위험해집니다.',
        ],
      },
      {
        heading: '정산',
        items: [
          '덱이 떨어지면 손패를 전부 공개해 회사별 대주주를 정합니다.',
          '대주주는 다른 사람들이 가진 그 회사 카드 한 장당 회사 가치만큼 받습니다 — 가치는 그 회사의 총 장수입니다.',
          '긱스 3원부터 더브 8원까지, 장수가 적은 회사일수록 귀하지만 대주주 되기도 쉽습니다.',
        ],
      },
    ],
  },
  bang: {
    ...
    title: '뱅!',
    tag: '정체 은닉 · 서부극',
    description: '보안관과 무법자가 사거리 안에서 총을 겨누는 서부극',
    players: '4~7인',
    minPlayers: 4,
    maxPlayers: 7,
    categories: ['정체 은닉', '블러핑'],
    duration: '30-40분',
    wsPath: '/ws/bang',
    logPrefix: '[뱅] WebSocket',
    sessionKey: 'bg_session_id',
    rules: [
      {
        heading: '역할',
        items: [
          '보안관은 시작부터 정체를 공개하고 체력이 1 많습니다. 무법자 전원과 배신자를 제거하면 이깁니다.',
          '부관은 보안관 편이지만 정체를 숨깁니다 — 너무 일찍 나서면 무법자의 표적이 됩니다.',
          '무법자는 보안관만 잡으면 이기고, 배신자는 마지막까지 혼자 살아남아야 이깁니다.',
        ],
      },
      {
        heading: '거리',
        items: [
          '원탁에 앉은 순서로 양쪽 중 짧은 쪽이 거리입니다. 탈락한 사람은 자리에서 빠져 거리가 줄어듭니다.',
          '무기 사거리 안에 있는 사람만 뱅!으로 쏠 수 있고, 기본 사거리는 1입니다.',
          '야생마를 깐 사람은 남이 볼 때 거리가 1 멀어지고, 조준경을 깐 사람은 남을 볼 때 거리가 1 가까워집니다.',
        ],
      },
      {
        heading: '차례',
        items: [
          '다이너마이트·감옥을 판정하고, 카드 2장을 뽑고, 원하는 만큼 카드를 쓴 뒤, 손패를 남은 체력 수만큼으로 줄입니다.',
          '뱅!은 한 차례에 한 장만 쓸 수 있습니다 — 볼캐닉을 깔면 제한이 풀립니다.',
          '뱅!을 맞으면 빗나감!으로 막거나 체력이 1 줄고, 술통이 있으면 카드를 뒤집어 ♥가 나올 때 피합니다.',
        ],
      },
    ],
  },
  ricochet: {
    ...
    title: '리코셰 로봇',
    tag: '실시간 · 최단 수 찾기',
    description: '벽에 부딪힐 때까지 미끄러지는 로봇으로 목표에 닿는 최단 수를 먼저 찾는 퍼즐',
    players: '1~8인',
    minPlayers: 1,
    maxPlayers: 8,
    categories: ['전략', '실시간'],
    duration: '20-30분',
    wsPath: '/ws/ricochet',
    logPrefix: '[리코셰 로봇] WebSocket',
    sessionKey: 'rr_session_id',
    rules: [
      {
        heading: '미끄러지는 로봇',
        items: [
          '16×16 판에 로봇 네 대가 있습니다. 로봇을 한 방향으로 보내면 벽이나 다른 로봇에 막힐 때까지 멈추지 않고 미끄러집니다.',
          '한 칸씩 움직일 수는 없습니다 — 다른 로봇을 벽 대신 세워 두는 것이 이 게임의 전부입니다.',
          '목표는 색과 칸으로 주어집니다. 그 색 로봇이 그 칸에 도착하면 됩니다.',
        ],
      },
      {
        heading: '외치기와 증명',
        items: [
          '차례가 없습니다. 답을 찾은 사람이 몇 수만에 가능한지 먼저 외칩니다.',
          '누군가 외치면 카운트다운이 시작되고, 그 사이 누구든 더 낮은 수를 외칠 수 있습니다.',
          '시간이 끝나면 가장 낮게 외친 사람이 실제로 옮겨 증명합니다. 실패하면 그다음으로 낮게 외친 사람에게 기회가 넘어갑니다.',
        ],
      },
      {
        heading: '승리',
        items: [
          '증명에 성공하면 그 목표 토큰을 가져갑니다 — 1점입니다.',
          '목표 토큰 17개를 모두 소진하면 게임이 끝나고, 가장 많이 가져간 사람이 이깁니다.',
          '무리하게 외치면 손해입니다 — 증명하지 못하면 그다음 사람에게 기회를 넘겨주게 됩니다.',
        ],
      },
    ],
  },
  rummikub: {
    ...
    title: '루미큐브',
    tag: '타일 조합 · 숫자조합',
    description: '테이블을 헐고 다시 짜서 받침대를 먼저 비우는 타일 게임',
    players: '2~4인',
    minPlayers: 2,
    maxPlayers: 4,
    categories: ['전략'],
    ...
    sessionKey: 'ru_session_id',
    rules: [
      {
        heading: '세트',
        items: [
          '세트는 두 종류입니다. 그룹은 색이 다른 같은 숫자 3~4개, 연속은 색이 같고 숫자가 이어지는 3개 이상입니다.',
          '조커는 어떤 타일도 대신합니다. 놓인 자리의 숫자로 값이 정해집니다.',
          '타일은 빨강·파랑·검정·주황 4색에 1~13이 두 벌씩, 조커 2개까지 모두 106개입니다.',
        ],
      },
      {
        heading: '등록',
        items: [
          '처음 내려놓을 때는 자기 타일로만 만든 세트들의 합이 30점을 넘어야 합니다.',
          '이때는 테이블 위 타일과 섞을 수 없고, 등록한 차례에는 숫자조합도 할 수 없습니다.',
          '내려놓을 게 없으면 타일더미에서 하나 가져오고 차례가 끝납니다.',
        ],
      },
      {
        heading: '숫자조합',
        items: [
          '등록을 마치면 테이블 위 세트를 마음대로 헐고 다시 짤 수 있습니다 — 이 게임의 묘미입니다.',
          '단 차례가 끝날 때 테이블의 모든 세트가 유효해야 하고, 내 타일이 최소 하나는 새로 나가야 합니다.',
          '숫자조합을 한 차례에는 타일을 가져올 수 없습니다.',
        ],
      },
      {
        heading: '점수',
        items: [
          '받침대를 먼저 비운 사람이 이깁니다.',
          '진 사람은 남은 타일의 숫자만큼 잃고 조커는 50점입니다. 그 합계가 그대로 이긴 사람의 점수가 됩니다.',
          '끝까지 등록하지 못하면 남은 타일과 무관하게 100점을 잃습니다.',
        ],
      },
    ],
  },
  bohnanza: {
    ...
    title: '보난자',
    tag: '콩 심기 · 거래',
    description: '손패 순서를 바꿀 수 없는 채로 콩을 심고 팔아 금화를 모으는 거래전',
    players: '3~5인',
    minPlayers: 3,
    maxPlayers: 5,
    categories: ['전략', '블러핑'],
    ...
    sessionKey: 'bz_session_id',
    rules: [
      {
        heading: '손패 순서',
        items: [
          '이 게임의 핵심입니다 — 손패 순서는 절대 바꿀 수 없습니다.',
          '뽑은 카드는 맨 뒤에 붙고, 심을 때는 맨 앞부터만 나갑니다.',
          '그래서 맨 앞 카드가 애물단지면 거래로 넘기거나 밭을 갈아엎어야 합니다.',
        ],
      },
      {
        heading: '차례',
        items: [
          '① 맨 앞 카드를 반드시 심습니다. 두 번째 카드까지는 선택입니다.',
          '② 덱에서 2장을 공개하고, 그 카드와 손패를 남들과 거래하거나 그냥 줍니다. 모든 거래에는 차례인 사람이 끼어야 합니다.',
          '③ 거래로 받은 카드는 손에 들 수 없고 즉시 전부 심습니다. ④ 마지막으로 3장을 뽑아 손패 맨 뒤에 붙입니다.',
        ],
      },
      {
        heading: '콩밭과 수확',
        items: [
          '밭은 둘로 시작하고, 세 번째 밭은 금화 3개로 살 수 있습니다.',
          '한 밭에는 같은 콩만 심습니다. 수확하면 콩미터대로 금화를 받는데, 문턱에 못 미치면 한 개도 못 받습니다.',
          '2장 이상인 밭이 있으면 1장짜리 밭은 수확할 수 없습니다.',
        ],
      },
      {
        heading: '승리',
        items: [
          '덱이 세 번째로 떨어지면 끝납니다 (3인은 두 번째).',
          '남은 밭을 모두 수확해 정산하고, 금화가 가장 많은 사람이 이깁니다.',
          '동점이면 손에 카드가 많은 사람이 이깁니다.',
        ],
      },
    ],
  },
  avalon: {
    ...
    rules: [
      ...
      },
      {
        heading: '원정 (5라운드)',
        items: [
          '대표가 돌아가며 원정대를 지명하고, 전원이 공개 찬반 투표합니다. 과반 찬성이면 원정을 떠납니다.',
