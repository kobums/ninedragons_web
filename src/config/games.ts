    ...
    rules: [
      {
        ...
        items: [
          ...
          '뽑은 카드가 💣 폭탄이면 🛡 디퓨즈를 써야 살아남습니다. 없으면 탈락!',
          '디퓨즈를 쓰면 폭탄을 덱 아무 곳에나 몰래 되꽂습니다 — 다음 사람을 노려보세요.',
        ],
      },
      {
        heading: '카드',
        items: [
          '⏭ 건너뛰기(뽑지 않고 차례 종료) · ⚔️ 공격(다음 사람이 두 번) · 🔀 셔플 · 🔮 예지(맨 위 3장을 나만 봄)',
          '🙏 부탁(상대가 카드 한 장을 줌) · 같은 고양이 2장(상대 카드 무작위로 뺏기)',
          '🚫 노프는 남이 낸 카드를 무효로 만듭니다. 노프 위에 노프를 겹칠 수 있어 짝수면 다시 유효해집니다.',
        ],
      },
      {
        heading: '승리',
