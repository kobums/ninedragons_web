...
export const GAMES: Record<GameId, GameMeta> = {
  ...
  spyfall: {
    title: '스파이폴',
    tag: '스파이 · 추리',
    description: '스파이만 장소를 모르는 질문 게임',
    players: '3~8인',
    duration: '5-10분',
    cardTheme: 'cream',
    wsPath: '/ws/spyfall',
    ...
    rules: [
      {
        heading: '준비',
        items: [
          '3~8명이 참가합니다. 24곳 중 한 장소가 정해지고, 스파이 1명을 제외한 전원이 그 장소를 알게 됩니다.',
          '스파이는 자신이 스파이라는 것만 알고, 장소는 모릅니다.',
      ...
      },
      {
        heading: '진행',
        items: [
          '타이머(3/5/8분) 동안 서로 장소에 대해 질문을 주고받으세요. 너무 노골적이면 스파이에게 장소를 들키고, 너무 모호하면 당신이 의심받습니다.',
          '스파이는 타이머 중 언제든 장소를 추리할 수 있습니다 — 맞히면 즉시 스파이 승리, 틀리면 즉시 패배입니다.',
        ],
      },
      {
        heading: '투표와 승리',
        items: [
          '타이머가 끝나면 전원이 스파이로 의심되는 사람에게 공개 투표합니다.',
